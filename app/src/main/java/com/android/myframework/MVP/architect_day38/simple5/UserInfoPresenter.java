package com.android.myframework.MVP.architect_day38.simple5;

import com.android.myframework.MVP.architect_day38.retrofit.BaseSubscriber;
import com.android.myframework.MVP.architect_day38.retrofit.UserInfo;
import com.android.myframework.MVP.architect_day38.simple5.base.BasePresenter;
...
public class UserInfoPresenter extends BasePresenter<UserInfoContract.UserInfoView> implements UserInfoContract.UserInfoPresenter {
    ...
    // 如果说你的项目有这种一对多的情况（待会参考我写的 1个View对应多个Presneter的解决方案）
    // 写一个 一对一的情况
